...
# Delay for BIOS update - if BIOS release is older than the delay, it will continue the process. This variable defines after how many days the client needs to be restarted
$Reboot_Delay = 14
